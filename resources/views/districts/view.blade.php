        ...
        <div class="card">
            <div class="card-body">
                <dl class="row">
                    ...
                    <dd class="col-md-8">{{ $district->id ?? '' }}</dd>
                </dl>

                <dl class="row">
                    <dt class="col-md-4">{{ __('Country Name') }}</dt>
                    <dd class="col-md-8">{{ $district->state->country->name ?? '' }}</dd>
                </dl>
                
                <dl class="row">
                    <dt class="col-md-4">{{ __('State Name') }}</dt>
                    <dd class="col-md-8">{{ $district->state->name ?? '' }}</dd>
                </dl>

                <dl class="row">
                    <dt class="col-md-4">{{ __('District Name') }}</dt>
                    <dd class="col-md-8">{{ $district->name ?? '' }}</dd>
                </dl>


                <dl class="row">
                    <dt class="col-md-4">{{ __('Status') }}</dt>
                    <dd class="col-md-8">{{ ucfirst($district->status) }}</dd>
                </dl>
