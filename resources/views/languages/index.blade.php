...
@section('content_header')
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <a href="{{route('languages.create')}}" class="btn btn-secondary"><i class="fa fa-plus mr-1"></i> Add Language</a>
        </div>
    </div>
@stop
    ...
    $(document).ready(function() {
        ...
        $('#index_table').DataTable({
            ...
            columns: [
                ...
                {data: 'language_name', name: 'language_name', defaultContent: defaultText},
        ...
        $(document).on('click', '.statusBtn', function(e) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ url('admin/languages/change-status') }}"+'/'+id,
                        data:{
                            'status': status,
                            '_token': '{{ csrf_token() }}',
                        },
