...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form id="qsForm" method="POST" action="{{ route('languages.store') }}">
                    @csrf

                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="language_name" class=" col-form-label text-md-end">{{ __('Name') }}</label>
                            <input id="language_name" type="text" class="form-control @error('language_name') is-invalid @enderror" name="language_name" value="{{ old('language_name') }}" autocomplete="language_name" autofocus>
