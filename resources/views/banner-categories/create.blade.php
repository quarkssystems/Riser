...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form id="qsForm" method="POST" action="{{ route('banner-categories.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-0">
                        <div class="col-md-6">
                            ...
                            <a href="{{route('banner-categories.index')}}" class="btn btn-secondary ml-1">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
