...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form id="qsForm" method="POST" action="{{ route('admins.update', $admin->iUserId) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="first_name" class=" col-form-label text-md-end">{{ __('First Name') }}</label>
                            <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name', $admin->vFirstName) }}" autocomplete="first_name" autofocus>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name', $admin->vLastName) }}" autocomplete="last_name" autofocus>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $admin->vEmail) }}" autocomplete="email" autofocus readonly>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username', $admin->username) }}" autocomplete="username" autofocus>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <img src="{{ $admin->profile_picture_url }}" width="50" alt="profile" class="mt-4 user-image img-circle elevation-2" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select id="gender" name="gender" class="form-control select2 @error('gender') is-invalid @enderror">
                                ...
                                {!! getSelectOptions($dataGen, $admin->eGender) !!}
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="profession" type="text" class="form-control @error('profession') is-invalid @enderror" name="profession" value="{{ old('profession', $admin->vOccupation) }}" autocomplete="profession" autofocus>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input id="contact_number" type="text" class="form-control @error('contact_number') is-invalid @enderror" name="contact_number" value="{{ old('contact_number', $admin->vPhoneNumber) }}" autocomplete="contact_number" autofocus>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="whatsapp_number" type="text" class="form-control @error('whatsapp_number') is-invalid @enderror" name="whatsapp_number" value="{{ old('whatsapp_number', $admin->whatsapp_number) }}" autocomplete="whatsapp_number" autofocus>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea id="about_me" class="form-control @error('about_me') is-invalid @enderror" name="about_me">{{ old('about_me', $admin->tAboutMe) }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea id="user_skills" class="form-control @error('user_skills') is-invalid @enderror" name="user_skills">{{ old('user_skills', $admin->vSkill) }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea id="user_experience" class="form-control @error('user_experience') is-invalid @enderror" name="user_experience">{{ old('user_experience', $admin->vExperience) }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea id="business_name" class="form-control @error('business_name') is-invalid @enderror" name="business_name">{{ old('business_name', $admin->business_name) }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input id="facebook_link" type="text" class="form-control @error('facebook_link') is-invalid @enderror" name="facebook_link" value="{{ old('facebook_link', $admin->facebook_link) }}" autocomplete="facebook_link" autofocus>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="twitter_link" type="text" class="form-control @error('twitter_link') is-invalid @enderror" name="twitter_link" value="{{ old('twitter_link', $admin->twitter_link) }}" autocomplete="twitter_link" autofocus>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input id="linkedin_link" type="text" class="form-control @error('linkedin_link') is-invalid @enderror" name="linkedin_link" value="{{ old('linkedin_link', $admin->linkedin_link) }}" autocomplete="linkedin_link" autofocus>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="instagram_link" type="text" class="form-control @error('instagram_link') is-invalid @enderror" name="instagram_link" value="{{ old('instagram_link', $admin->instagram_link) }}" autocomplete="instagram_link" autofocus>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input id="youtube_link" type="text" class="form-control @error('youtube_link') is-invalid @enderror" name="youtube_link" value="{{ old('youtube_link', $admin->youtube_link) }}" autocomplete="youtube_link" autofocus>
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="status" name="status" class="form-control select2 @error('status') is-invalid @enderror">
                                ...
                                {!! getSelectOptions($data, $admin->status) !!}
                            </select>
                    ...
                    <div class="row mb-0">
                        <div class="col-md-6">
                            ...
                            <a href="{{route('admins.index')}}" class="btn btn-secondary ml-1">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
...
@section('js')
    ...
    $(document).ready(function() {
        setTimeout(function () {
            var country_id = "{{ $admin->country_id }}";
            if(country_id) {
