...
@section('content_header')
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <a href="{{route('agents.create')}}" class="btn btn-secondary"><i class="fa fa-plus mr-1"></i> Add Agent</a>
        </div>
    </div>
@stop
        ...
        $(document).on('click', '.deleteBtn', function(e) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ url('admin/agents/invited/delete') }}/"+id,
                        data:{
                            'id': id,
                            '_token': '{{ csrf_token() }}',
                        },
        ...
        $(document).on('click', '.approveBtn', function(e) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ url('admin/agents/invited/change-status') }}"+'/'+id,
                        data:{
