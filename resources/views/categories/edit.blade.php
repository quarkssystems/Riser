...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form id="qsForm" method="POST" action="{{ route('categories.update', $category->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            @if ($category->category_image)
                                <img src="{{ $category->category_image_url }}" alt="" width="150" />
                            @endif
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea id="category_description" class="form-control @error('category_description') is-invalid @enderror" name="category_description">{{ old('category_description', $category->category_description) }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select id="status" name="status" class="form-control select2 @error('status') is-invalid @enderror">
                                ...
                                {!! getSelectOptions($data, $category->status) !!}
                            </select>
