...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form id="qsForm" method="POST" action="{{ route('talukas.update', $taluka->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-12">
                            ...
                            <select id="country_id" name="country_id" class="form-control select2 @error('country_id') is-invalid @enderror">
                                ...
                                @foreach ( $countryData as $country )
                                    <option value="{{ $country->id }}" {{ ($country->id == $taluka->district->state->country->id) ? 'selected' : '' }}> {{ $country->name }} </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="district_id" class=" col-form-label text-md-end">{{ __('District Name') }}</label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $taluka->name) }}" autocomplete="name" autofocus>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <select id="status" name="status" class="form-control select2 @error('status') is-invalid @enderror">
                                ...
                                {!! getSelectOptions($data, $taluka->status) !!}
                            </select>
...
@section('js')
    ...
    $(document).ready(function() {
        ...
        setTimeout(function () {
            var country_id = "{{ $taluka->district->state->country->id }}";
            if(country_id) {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if(response) {
                            ...
                            var state_id = "{{ $taluka->district->state_id }}";
                            if(state_id) {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if(response) {
                            ...
                            var district_id = "{{ $taluka->district_id }}";
                            if(district_id) {
