...
@section('content_header')
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <a href="{{route('posts.create')}}" class="btn btn-secondary"><i class="fa fa-plus mr-1"></i> Add Post</a>
        </div>
    </div>
@stop
    ...
    $(document).ready(function() {
        ...
        $('#index_table').DataTable({
            ...
            columns: [
                ...
                {data: 'user.full_name', name: 'full_name', defaultContent: defaultText, orderable: false, searchable: true},
                {data: 'views', name: 'views', defaultContent: defaultText},
        ...
        $(document).on('click', '.statusBtn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var status = $(this).attr('data-status');
                    $.ajax({
                        url: "{{ url('admin/posts/change-status') }}"+'/'+id,
                        data:{
                            'status': status,
                            '_token': '{{ csrf_token() }}',
                        },
