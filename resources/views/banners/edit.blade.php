...
@php
    $title = 'Edit Banner';
    $selectedCategories = $banner->bannerCategories->pluck('id')->toArray();
@endphp
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form id="qsForm" method="POST" action="{{ route('banners.update', $banner->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $banner->name) }}" autocomplete="name" autofocus>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            @if ($banner->banner_image)
                                <img src="{{ $banner->banner_image_url }}" alt="" width="150" />
                            @endif
                            @error('banner_image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description">{{ old('description', $banner->description) }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select id="status" name="status" class="form-control select2 @error('status') is-invalid @enderror">
                                ...
                                {!! getSelectOptions($data, $banner->status) !!}
                            </select>
