...
@section('content_header')
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <a href="{{route('banners.create')}}" class="btn btn-secondary"><i class="fa fa-plus mr-1"></i> Add Banner</a>
        </div>
    </div>
@stop
    ...
    $(document).ready(function() {
        ...
        $('#index_table').DataTable({
            ...
            columns: [
                ...
                {data: 'banner_image_url', name: 'banner_image_url', defaultContent: defaultText,
        ...
        $(document).on('click', '.statusBtn', function(e) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ url('admin/banners/change-status') }}"+'/'+id,
                        data:{
                            'status': status,
                            '_token': '{{ csrf_token() }}',
                        },
